...
const ChatInterface = () => {
  ...
  const handleSendMessage = (e) => {
    ...
    // This will be replaced with GraphQL mutations later
    const newMessage = {
      id: Date.now(),
      content: message,
      user_id: user.id,
    ...
    setTimeout(() => {
      const botMessage = {
        id: Date.now() + 1,
        content: `I received your message: "${message}". This is a placeholder response. The actual chatbot will be connected later.`,
        user_id: 'bot',
        created_at: new Date().toISOString(),
        is_bot: true
      }
